...
class ShiftCipher:
    ...
    def __init__(self, shift):
        ...
        self.cipher = {self.letters[i]: self.letters[(i+self.shift) % len(self.letters)] for i in range(len(self.letters))}
        self.decoder ={v:k for k,v in self.cipher.items()}
    ...
    def decode(self, message):
        ...
        """
        return self.transform_message(self.transform_message(test,self.cipher),self.decoder)
